            ...
            <ScrollAnimateWrapper animation="fadeInUp" delay="stagger-2" className="mb-8">
              <div className="bg-black/20 backdrop-blur-sm rounded-xl px-6 py-4 max-w-3xl mx-auto border border-white/20">
                <p className="text-base md:text-lg text-white font-medium leading-relaxed drop-shadow-xl">
                  Services professionnels de <span className="text-yellow-400 font-semibold">manutention et assistance au sol</span> pour
        ...
        <div className="container-custom">
          <ScrollAnimateWrapper animation="revealUp" className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Assistance complète pour toutes vos opérations au sol
            </p>
          </ScrollAnimateWrapper>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Chargement & Déchargement</h3>
              <p className="text-gray-600">Manutention sécurisée du fret et des bagages avec équipement spécialisé.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Assistance au Sol</h3>
              <p className="text-gray-600">Services complets d'assistance aux aéronefs et aux équipages.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Coordination</h3>
              <p className="text-gray-600">Gestion et coordination des opérations au sol en temps réel.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom relative z-10">
          <ScrollAnimateWrapper animation="scaleIn" className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
              Équipe qualifiée et équipements aux normes internationales
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/contact"
