        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8 relative z-10">
          <ScrollAnimateWrapper animation="bounceIn" className="text-center mb-4 sm:mb-6">
            <div className="inline-flex items-center gap-1.5 bg-black/40 backdrop-blur-md border border-white/40 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-2xl">
              ...
              <span className="text-white text-xs font-medium drop-shadow-lg">Services Aéroportuaires</span>
            </div>
          ...
          <ScrollAnimateWrapper animation="revealUp" className="text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-3 sm:mb-4">
              <span className="drop-shadow-2xl text-shadow-lg">Manutention Aéroportuaire</span>
            </h1>
            ...
            <ScrollAnimateWrapper animation="fadeInUp" delay="stagger-2" className="mb-6 sm:mb-8">
              <div className="bg-black/20 backdrop-blur-sm rounded-lg sm:rounded-xl px-4 sm:px-6 py-3 sm:py-4 max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-3xl mx-auto border border-white/20">
                <p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed drop-shadow-xl">
                  <span className="text-yellow-400 font-semibold">Manutention des Bagages & Assistance PMR</span> - Services professionnels pour les opérations aéroportuaires
                </p>
              </div>
            </ScrollAnimateWrapper>
        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <ScrollAnimateWrapper animation="revealUp" className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-3 sm:mb-4 md:mb-6">
              Notre Service : Manutention des Bagages & Assistance PMR
            </h2>
          </ScrollAnimateWrapper>

          {/* Manutention des bagages */}
          <ScrollAnimateWrapper animation="revealUp" className="mb-12">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg">
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Manutention des bagages</h3>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                EPS met à votre disposition une équipe expérimentée, formée aux procédures de sécurité et aux standards aéroportuaires internationaux.
              </p>
              <p className="text-lg text-gray-700 mb-4 font-semibold">Nos agents assurent la prise en charge complète des bagages :</p>
              <ul className="space-y-3 mb-6">
                {[
                  'Chargement et déchargement des soutes',
                  'Tri et transport sur les pistes et terminaux',
                  'Gestion et acheminement en toute sécurité',
                  'Assistance à la livraison des bagages aux passagers'
                ].map((item, idx) => (
              ...
              <p className="text-lg text-gray-700 italic">
                Grâce à une organisation rigoureuse et un matériel adapté, nous garantissons rapidité, fiabilité et sécurité à chaque étape du processus.
              </p>
            </div>
          </ScrollAnimateWrapper>
          ...
          <ScrollAnimateWrapper animation="revealUp">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg">
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Assistance aux personnes à mobilité réduite (PMR)</h3>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              ...
              <p className="text-lg text-gray-700 mb-4 font-semibold">Nos agents spécialisés accompagnent les passagers depuis leur arrivée à l'aéroport jusqu'à leur embarquement (et inversement), en assurant :</p>
              <ul className="space-y-3 mb-6">
                {[
              ...
              <p className="text-lg text-gray-700 font-semibold italic text-blue-700">
        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8 relative z-10">
          <ScrollAnimateWrapper animation="scaleIn" className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-8 sm:mb-10 md:mb-12 max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-3xl mx-auto">
              Équipe expérimentée formée aux standards aéroportuaires internationaux
            </p>
